...
describe('UtcPipe', () => {
  ...
  describe('#transform', () => {
    ...
    it('should parse with provided timezone and format to UTC', () => {
      ...
      expect(amDateFormat.transform(utcOutput, dayjsFormatString)).toEqual('2017-01-01');
    });
    ...
    it('should parse as UTC without provided timezone', () => {
      ...
      const dayjsFormatString = 'YYYY-MM-DD';
      const utcOutput = utcDatePipe.transform(datetimeString);
      expect(amDateFormat.transform(utcOutput, dayjsFormatString)).toEqual('2016-12-31');
    });
